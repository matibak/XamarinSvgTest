...
extern void *mono_aot_module_SvgTest_iOS_info;
...
extern void *mono_aot_module_Forms9Patch_iOS_info;
extern void *mono_aot_module_Forms9Patch_info;
extern void *mono_aot_module_FormsGestures_info;
extern void *mono_aot_module_P42_Utils_info;
...
extern void *mono_aot_module_SkiaSharp_Extended_Svg_info;
extern void *mono_aot_module_Xamarin_Essentials_info;
extern void *mono_aot_module_OpenTK_1_0_info;
extern void *mono_aot_module_P42_NumericalMethods_info;
extern void *mono_aot_module_P42_Utils_iOS_info;
extern void *mono_aot_module_FormsGestures_iOS_info;
extern void *mono_aot_module_SvgTest_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_FFImageLoading_Svg_Forms_info;
extern void *mono_aot_module_FFImageLoading_Svg_Platform_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_SvgTest_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Forms9Patch_iOS_info);
	mono_aot_register_module (mono_aot_module_Forms9Patch_info);
	mono_aot_register_module (mono_aot_module_FormsGestures_info);
	mono_aot_register_module (mono_aot_module_P42_Utils_info);
	...
	mono_aot_register_module (mono_aot_module_SkiaSharp_Extended_Svg_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Essentials_info);
	mono_aot_register_module (mono_aot_module_OpenTK_1_0_info);
	mono_aot_register_module (mono_aot_module_P42_NumericalMethods_info);
	mono_aot_register_module (mono_aot_module_P42_Utils_iOS_info);
	mono_aot_register_module (mono_aot_module_FormsGestures_iOS_info);
	mono_aot_register_module (mono_aot_module_SvgTest_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_FFImageLoading_Svg_Forms_info);
	mono_aot_register_module (mono_aot_module_FFImageLoading_Svg_Platform_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SvgTest.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
