...
@class F9PPopupWindow;
@class Forms9PatchPopupPlatformRenderer;
@class Forms9Patch_iOS_PopupPageRenderer;
@class Forms9Patch_iOS_PopupBaseRenderer;
@class Forms9Patch_iOS_PdfRenderer;
@class Forms9Patch_iOS_WKNavigationCompleteCallback;
@class Forms9Patch_iOS_PrintService;
@class Forms9Patch_iOS_ToPdfService;
...
@interface Forms9Patch_iOS_PopupPageRenderer : Xamarin_Forms_Platform_iOS_PageRenderer {
}
	-(void) viewDidLoad;
	-(void) viewDidUnload;
	-(void) viewWillAppear:(BOOL)p0;
...
@interface Forms9Patch_iOS_PopupBaseRenderer : Forms9Patch_iOS_PopupPageRenderer {
}
	-(BOOL) canBecomeFirstResponder;
	-(void) OnKeyPress:(UIKeyCommand *)p0;
	-(NSArray *) keyCommands;
...
@interface Forms9Patch_iOS_PrintService : NSObject<UIPrintInteractionControllerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Forms9Patch_iOS_ToPdfService : NSObject<UIPrintInteractionControllerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface MvxSvgCachedImageView : MvxCachedImageView {
}
	-(id) init;
@end
